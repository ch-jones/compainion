...
function circlesHistory() {
    //draw circle
    //    if (dateValue) {
    //        if (data[dateValue].myValue == 0) {
    //            //level 0
    //            fill(250);
    //        } else if (data[dateValue].myValue == 1) {
    //            //level 1
    //            fill(224, 247, 250);
    //        } else if (data[dateValue].myValue == 2) {
    //            //level 2
    //            fill(232, 245, 233);
    //        } else if (data[dateValue].myValue == 3) {
    //            //level 3
    //            fill(240, 244, 195);
    //        } else if (data[dateValue].myValue == 4) {
    //            //level 4
    //            fill(230, 238, 156);
    //        } else if (data[dateValue].myValue == 5) {
    //            //level 5
    //            fill(255, 241, 118);
    //        } else if (data[dateValue].myValue == 6) {
    //            //level 6
    //            fill(255, 238, 88);
    //        } else if (data[dateValue].myValue == 7) {
    //            //level 7
    //            fill(255, 213, 79);
    //        } else if (data[dateValue].myValue == 8) {
    //            //level 8
    //            fill(255, 167, 38);
    //        } else if (data[dateValue].myValue == 9) {
    //            //level 9
    //            fill(255, 87, 34);
    //        } else if (data[dateValue].myValue == 10) {
    //            //level 10
    //            fill(216, 67, 21);
    //        }
    //        
